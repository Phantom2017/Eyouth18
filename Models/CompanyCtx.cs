...
namespace Eyouth1.Models
{
    ...
    public class CompanyCtx : IdentityDbContext<AppUser>
    {
        public CompanyCtx()
        {
    ...
    //public class CompanyCtx:DbContext
public DbSet<Eyouth1.ViewModels.RegisterVM> RegisterVM { get; set; } = default!;
    //public class CompanyCtx:DbContext
public DbSet<Eyouth1.ViewModels.LoginVM> LoginVM { get; set; } = default!;
    }
}
